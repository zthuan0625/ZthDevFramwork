	...
	window[e] = function(r, i, s) {
		...
		save: function(t, n, i) {
			...
			if (!this.layers.length)
            {
                ...
                return this.canvas.toDataURL(s, n);
            }
			...
			n = function(n)
            {
				...
				var i = {
					...
					shiftAction: function() {
						...
						var s = e[0];
						if (s == "act")
                            r.postMessage(["act", e[1], n.imgData, e[2]]);
						else if (s == "add")
                        {
							function o() {
								if (e[1].readyState) {
                            ...
                            s == "show" ? (n.show(e[1], e[2], 1), this.shiftAction())
                            : s == "complete" ? (e[1] && e[1](), this.shiftAction())
                            : s == "clone" ? (n.clone(1),  this.shiftAction())
                            : s == "save" ? (n.save(0, 1), this.shiftAction())
                            : s == "replace" && (n.replace(e[1], 1), this.shiftAction())
					},
					callback: function(e) {
