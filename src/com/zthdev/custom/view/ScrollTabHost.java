...
/**
 * 
 * 类名称：ScrollTabHost <br>  
 * 类描述：可以滑动切换的TabHost <br>
 * 创建人：赵腾欢   
 * 创建时间：2014-10-20 下午2:41:08 <br>  
 * @version V1.0
 */
public class ScrollTabHost extends FrameLayout implements ViewTreeObserver.OnTouchModeChangeListener
{
    ...
    /**
     * whether the switch animation is end
     */
    private boolean isAnimationEnd = true;
    /**
     * the switch animation,you can modify it to meet you demand
     */
    private TranslateAnimation mLeftInAnim,mLeftOutAnim,mRightInAnim,mRightOutAnim;
    
    /**
     * TabWidgetLocation<{@link #getTabWidgetLocation}>
     */
    ...
    public void setup() 
    {
        mTabWidget = (ScrollTabWidget) findViewById(android.R.id.tabs);
        if (mTabWidget == null) 
        {
        ...
        mTabWidget.setTabSelectionListener(new ScrollTabWidget.OnTabSelectionChanged() 
        {
    ...
    public void setCurrentTab(int index) 
    {
        ...
        // if the switching animation is not end , then return
        if(!isAnimationEnd)
        {
            return;
        }
        ...
        mCurrentTab = index;
        final ScrollTabHost.TabSpec spec = mTabSpecs.get(index);
        ...
        //if the old view is null ,represent the tabHost is first to show
        //then do not need switching animation as well as the switching animation is null.
        ...
        //set animation end true SWITCH_ANIM_DURATION(the animation duration) delayed
    ...
    private class LabelIndicatorStrategy implements IndicatorStrategy 
    {
        ...
        public View createIndicatorView() 
        {
            ...
            tabIndicator.setLayoutParams(new  TableLayout.LayoutParams(
    ...
    private class LabelAndIconIndicatorStrategy implements IndicatorStrategy 
    {
        ...
        public View createIndicatorView() 
        {
            ...
            {
                //here if the tab just have a icon ,it need not to 
                //use a textView with setCompoundDrawablesWithIntrinsicBounds
                //just use a ImageView instead.
                ImageView icon = new ImageView(getContext());
                icon.setLayoutParams(new  TableLayout.LayoutParams(
                        ViewGroup.LayoutParams.WRAP_CONTENT, 
                        ViewGroup.LayoutParams.WRAP_CONTENT, 
                        1f));
